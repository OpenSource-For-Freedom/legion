...
Ollama-based evaluator. think=False disables Qwen's chain-of-thought when the
served model supports it; num_predict bounds length.
"""
...
def chat(model: str, system: str, user: str, *, host: str = DEFAULT_HOST,
         temperature: float = 0.3, num_ctx: int = 8192, timeout: float = 180.0,
         think: bool | None = False, num_predict: int = 700) -> str:
    payload = {
        "model": model,
