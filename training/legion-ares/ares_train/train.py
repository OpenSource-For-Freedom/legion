...
def train(data_dir, out_dir, *, tier="legion-ares:qwen3-4b", base_override=None,
          rank=32, alpha=32, dropout=0.05, steps=200, epochs=3.0, lr=2e-4,
          batch_size=1, grad_accum=8, max_length=2048, time_budget_min=30.0,
    ...
    sft_args = SFTConfig(
        ...
        learning_rate=lr, max_steps=steps if steps > 0 else -1, num_train_epochs=epochs,
