...
static VULNERABLE_AI_SDKS: &[VulnEntry] = &[
    ...
    (
        ...
        "Critical",
        "CVE-2024-28088",
        "RCE via unsafe deserialization in PALChain",
    ),
    (
        "langchain",
        "pypi",
        ...
        "Critical",
        "GHSA-prgp-w7vf-ch62",
        "Arbitrary code execution via Python REPL tool",
    ),
    (
        "langchain-core",
        "pypi",
        ...
        "High",
        "GHSA-2qmj-7962-cjq8",
        "Prompt injection via unsanitized output parsing",
    ),
    (
    ...
    (
        ...
        "High",
        "CVE-2024-1455",
        "SSRF via remote content fetching utilities",
    ),
    ...
    (
        ...
        "Critical",
        "CVE-2024-3568",
        "Arbitrary code execution via malicious pickle in model files (AML.T0018)",
    ),
    ...
    (
        ...
        "Critical",
        "CVE-2024-47084",
        "Arbitrary file read via path traversal in upload endpoint",
    ),
    (
        "gradio",
        "pypi",
        ...
        "Critical",
        "CVE-2024-1561",
        "Path traversal allows reading arbitrary server files",
    ),
    (
        "gradio",
        "pypi",
        ...
        "High",
        "CVE-2023-34239",
        "Authentication bypass in queue mechanism",
    ),
    ...
    (
        ...
        "High",
        "CVE-2024-3095",
        "RCE through unsafe eval in query execution module",
    ),
    (
        "llama-index",
        "pypi",
    ...
    (
        ...
        "0.28.0",
        "Medium",
        "GHSA-openai-log-2023",
        "API keys logged in plaintext — upgrade and rotate keys",
    ),
    ...
    (
        ...
        "High",
        "AML.T0037",
        "Unrestricted code execution by LLM agent by default — sandbox required",
    ),
    (
        "autogen",
        "pypi",
    ...
    (
        ...
        "Medium",
        "CVE-2024-3642",
        "SSRF via arbitrary remote dataset URL loading",
    ),
];
...
static KNOWN_AI_SDKS: &[(&str, &str, &str)] = &[
    ...
    (
        "openai",
        "pypi",
        "OpenAI Python SDK (GPT-4, DALL·E, Whisper)",
    ),
    ...
    (
        "langchain-experimental",
        "pypi",
        "LangChain EXPERIMENTAL — HIGH RISK in production",
    ),
    ...
    (
        "instructor",
        "pypi",
        "Structured LLM output (OpenAI / Anthropic)",
    ),
...
static AGENT_PROCESS_SIGS: &[(&str, &str, &str, Option<&str>)] = &[
    ...
    (
        "python",
        "guidance",
        "Microsoft Guidance LLM controller",
        Some("AML.T0040"),
    ),
